...
for str_type in ['train','val','test']:
    ...
    os.makedirs(os.path.join(base_folder,'patchesX','images',str_type))
    os.makedirs(os.path.join(base_folder,'patchesX','masks',str_type)) 

    print('processing:'+'mfc2016_'+str_type+'X.csv')

    with open('mfc2016_'+str_type+'X.csv') as f:
        ...
        for r in csv_file:
            ...
            if row.TaskID == "Splice":
                ...
                MASK_PATH = os.path.join(base_folder,row.ProbeMaskFileName)
                ...
                for h in range(img_patches.shape[0]):
                    for w in range(img_patches.shape[1]):
                        ...
                        PATCH_PATH = os.path.join(base_folder,'patchesX','images',str_type,str(count)+'.png')
                        MASK_PATCH_PATH = os.path.join(base_folder,'patchesX','masks',str_type,str(count)+'.png')
        ...
        with open(os.path.join(base_folder,'patchesX',str_type+'.txt'),'w') as f:
            f.write("\n".join(lst))    
